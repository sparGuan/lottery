import { query, remove, update, removeBets } from "../services/bets";
...
export default {
  ...
  effects: {
    ...
    *removeBets({ payload }, { call, put }) {
      yield put({ type: "showLoading" });
      const data = yield call(remove, payload);
      // const tableData = yield call(removeBets, payload);
