import { query, remove, update, removeGamesLevel } from "../services/gamesLevel";

export default {
  namespace: "gamesLevel",
  ...
  effects: {
    ...
    *removeGamesLevel({ payload }, { call, put }) {
      yield put({ type: "showLoading" });
      const data = yield call(remove, payload);
      console.log("delete payload", payload);
      // const tableData = yield call(removeGamesLevel, payload);
    ...
    *updateGamesLevel({ payload }, { call, put }) {
      yield put({ type: "showLoading" });
